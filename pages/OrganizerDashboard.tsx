...
const OrganizerDashboard: React.FC<OrganizerDashboardProps> = ({ navigateTo, onNotify, profile, events, hasUnread }) => {
  ...
  return (
    <div className="flex flex-col w-full pb-32 min-h-screen bg-background-light dark:bg-zinc-950 animate-in fade-in duration-500">
      ...
      <main className="p-6 pt-0 space-y-10">
        <section>
          <div className="flex flex-col mb-8">
            <div className="flex items-center justify-between mb-2">
              <p className="text-[10px] font-black text-zinc-400 uppercase tracking-[0.25em]">Área Administrativa</p>
              <div className="flex items-center gap-1.5 px-3 py-1 bg-primary/10 rounded-full">
                <div className="size-1.5 rounded-full bg-primary animate-pulse"></div>
                <span className="text-[8px] font-black uppercase tracking-widest text-primary">Sincronizado</span>
              </div>
            </div>
            <h3 className="text-[32px] font-[900] text-zinc-900 dark:text-white leading-none uppercase tracking-tighter">Olá, {firstName}</h3>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <button 
              ...
              className="flex flex-col items-center justify-center gap-4 p-8 rounded-[2.5rem] bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-white/5 shadow-xl premium-shadow transition-all active:scale-95 text-center group"
            >
              ...
              <span className="text-[10px] font-[900] uppercase text-zinc-500 dark:text-zinc-400 tracking-widest">Check-in</span>
            </button>
          </div>
        </section>
        ...
        <section>
           <div className="flex items-center justify-between mb-6">
            <h3 className="text-[10px] font-[900] uppercase tracking-[0.25em] text-zinc-400">Eventos Ativos</h3>
          ...
          <div className="space-y-4 pb-20">
            {events.length > 0 ? events.map(event => (
              <div 
                ...
                className="group flex gap-4 p-5 bg-white dark:bg-zinc-900 rounded-[2.5rem] shadow-xl premium-shadow border border-zinc-100 dark:border-white/5 cursor-pointer active:scale-[0.98] transition-all hover:border-primary/40"
              >
                ...
                <div className="flex-1 flex flex-col justify-center min-w-0">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="size-1 bg-zinc-200 dark:bg-zinc-700 rounded-full"></span>
                    <span className="text-[9px] font-bold text-zinc-400 uppercase">{event.status}</span>
                  </div>
                  <h4 className="text-[12px] font-[900] leading-tight truncate uppercase text-zinc-900 dark:text-white group-hover:text-primary transition-colors tracking-tight">{event.title}</h4>
                  <div className="flex items-center justify-between mt-4">
                    <div className="flex-1 bg-zinc-100 dark:bg-zinc-800 h-1.5 rounded-full overflow-hidden mr-3">
              ...
              <div className="py-20 text-center bg-zinc-50 dark:bg-zinc-900/50 rounded-[2.5rem] border-2 border-dashed border-zinc-200 dark:border-zinc-800 flex flex-col items-center">
                <span className="material-symbols-outlined text-4xl text-zinc-200 mb-4">event_busy</span>
                <p className="text-[10px] font-black text-zinc-400 uppercase tracking-widest">Nenhum evento registrado</p>
