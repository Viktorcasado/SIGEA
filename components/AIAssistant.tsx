...
const AIAssistant: React.FC<AIAssistantProps> = ({ events }) => {
  ...
  return (
    <>
      {/* Botão reposicionado para evitar overlap com o menu Perfil */}
      <button 
            ...
            <header className="p-8 bg-primary text-white flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-[10px] opacity-70 font-bold uppercase tracking-widest">Online agora</span>
                </div>
              </div>
